<template>
  <div class="cases">
    ...
    <el-table border :data="tableData" v-loading="loading" style="width: 100%">
      ...
      <el-table-column prop="typeKey" label="键" width="50" align="center"></el-table-column>
      ...
      <el-table-column prop="content1" label="内容1" width="180" align="center"></el-table-column>
      <el-table-column prop="content2" label="内容2" width="180" align="center"></el-table-column>
      <el-table-column prop="content3" label="内容3" width="180" align="center"></el-table-column>
  <!--    <el-table-column prop="content4" label="内容4" width="180" align="center"></el-table-column>-->
  ...
  export default {
    ...
    methods: {
      loadData() {
        this.loading = true;
        this.$http
                .post("imgDataDictionary/listAll", {}, this.options)
                .then(response => {
      ...
      openDialog() {
        ...
        this.formData.img = "";
        this.formData.title = "";
        this.formData.content1 = "";
        this.formData.content2 = "";
      ...
      handleCreateOrModify() {
        ...
        if (!this.formData.id) {
          ...
          this.loading = true;
          this.$http
                  .post("imgDataDictionary/create", this.formData, this.options)
                  .then(response => {
                    this.loading = false;
                    window.console.log(response);
                    this.$message({
          ...
          this.loading = true;
          this.$http
                  .post("imgDataDictionary/update/"+this.formData.id, this.formData, this.options)
                  .then(response => {
                    this.loading = false;
                    window.console.log(response);
                    this.$message({
        ...
        this.$confirm("此操作将永久此条数据, 是否继续?", "提示", {
          ...
          type: "warning"
                ...
                .then(() => {
                  ...
                  this.loading = true;
                  this.$http
                          .post(`imgDataDictionary/delete/`+row.id, null, this.options)
                          .then(response => {
                            this.loading = false;
                            window.console.log(response);
                            this.$message({
